...
public class KitchenMod {
	public static final Logger LOGGER = LogManager.getLogger(KitchenMod.class);
	...
	public KitchenMod() {
		...
		KitchenModBlocks.REGISTRY.register(bus);
		KitchenModItems.REGISTRY.register(bus);

		KitchenModBlockEntities.REGISTRY.register(bus);
		KitchenModFeatures.REGISTRY.register(bus);

		KitchenModMenus.REGISTRY.register(bus);
