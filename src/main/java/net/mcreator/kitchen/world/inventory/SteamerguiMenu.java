...
public class SteamerguiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public SteamerguiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(KitchenModMenus.STEAMERGUI.get(), id);
