...
public class FrypanguiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public FrypanguiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(KitchenModMenus.FRYPANGUI.get(), id);
		...
		this.customSlots.put(3, this.addSlot(new SlotItemHandler(internal, 3, 43, 44) {
		}));
		...
		this.customSlots.put(6, this.addSlot(new SlotItemHandler(internal, 6, 43, 62) {
		}));
		...
		this.customSlots.put(10, this.addSlot(new SlotItemHandler(internal, 10, 16, 26) {
			@Override
			public boolean mayPlace(ItemStack stack) {
